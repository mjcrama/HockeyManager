...
export interface MatchProfile {
  ...
  breakMinutes: number;            // default / first break (used as fallback)
  breakMinutesPerBreak?: number[]; // per-break durations when breaks differ
}
...
export const MATCH_PROFILES: Record<MatchProfileKey, MatchProfile> = {
  ...
  p17:    { label: '4×17.5 +2/5/2', periods: 4, periodMinutes: 17.5, breakMinutes: 2,
            breakMinutesPerBreak: [2, 5, 2] },
